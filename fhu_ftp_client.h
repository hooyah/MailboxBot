#ifndef __MAILBOXBOT_FTP
#define __MAILBOXBOT_FTP
...
class fhu_FTPClient
{
  ...
  public:
  fhu_FTPClient(char* _serverAdress, uint16_t _port, char* _userName, char* _passWord, uint16_t _timeout = 10000, uint8_t _verbose = 1);
  fhu_FTPClient(char* _serverAdress, char* _userName, char* _passWord, uint16_t _timeout = 10000, uint8_t _verbose = 1);
  void OpenConnection();
  ...
  bool DownloadFileToStream(const char *filenameRemote, File &outfile); 
};
